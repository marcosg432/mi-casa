...
(function (global) {
  var FALLBACK = [
    ...
    },
    {
      ...
      tipo: 'Quarto Duplo',
      desc:
        'Quarto Duplo. Confortável para casais ou viajantes: cama de casal, ar-condicionado, vista para o jardim e banheiro compartilhado com chuveiro. Até 2 pessoas · 20 m².',
      preco: 'R$ 150',
      precoLabel: 'Noite',
